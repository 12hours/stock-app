...
//    public static final String GET = Arrays.stream(ProductRestController.class.getMethods()).filter(m -> m.isAnnotationPresent(javax.ws.rs.GET.class) && (m.getParameterCount() == 1)).findAny().get().getName();
    ...
    public static final String PRODUCT_TYPE_GET_PRODUCTS = "getProductsOfType";
    ...
    public static final String PRODUCT_INCOME_GET_PRODUCT = "getProductForProductIncome";
    public static final String PRODUCT_INCOME_GET_SUPPLIER = "getSupplierForProductIncome";
    public static final String PRODUCT_INCOME_GET_USER = "getUserForProductIncome";
    ...
    public static final String SUPPLIER_GET_INCOMES = "getProductIncomesOfSupplier";
}
